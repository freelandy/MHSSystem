...
namespace PermissionBox.Dapper.Contrib.Extensions
{
    /// <summary>
...
#else
                //return Thread.GetDomain().DefineDynamicAssembly(new AssemblyName { Name = name }, AssemblyBuilderAccess.Run); // This API is now obsolete.
                return AssemblyBuilder.DefineDynamicAssembly(new AssemblyName { Name = name }, AssemblyBuilderAccess.Run);
#endif
            }
